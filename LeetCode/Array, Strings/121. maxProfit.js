...
// 	const min = findMin(prices);
// 	const max = findMax(prices);
...
// 	if(maxIdx < minIdx) {
// 		const left = maxProfit(prices.slice(0, maxIdx+1));
// 		const right = maxProfit(prices.slice(maxIdx+1));
// 		debugger;
...
// 			minprice = prices[i];
// 		}  else  {
// 			prices[i] - minprice > maxProfit ? maxProfit = prices[i] - minprice : maxProfit;
// 		}
